...
export function Class(props: PropsType) {
  return (
    <svg
...
export function Student(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function Attendance(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function Blacklist(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
